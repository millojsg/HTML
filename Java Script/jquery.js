...
(function(b, a) {
    ...
    bI.extend({
        ...
        isPlainObject: function(b7) {
            var i;
            if (!b7 || bI.type(b7) !== "object" || b7.nodeType || bI.isWindow(b7)) {
                return false
            }
            try {
    ...
    var m =
         ...
         */
        (function(de) {
            var cx, dh, cn, cG, cJ, cV, dl, cH, cW, cY, cB, co, c7, c2, df, ce, cE, c9 = "sizzle" + -(new Date()),
                cI = de.document,
                di = 0,
                c3 = 0,
                b9 = cz(),
                ...
                b6 = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
                cK = b6.replace("w", "w#"),
                c5 = "\\[" + cp + "*(" + b6 + ")" + cp + "*(?:([*^$|!~]?=)" + cp + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + cK + ")|)|)" + cp + "*\\]",
                ck = ":(" + b6 + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + c5.replace(3, 8) + ")*)|.*)\\)|)",
                cr = new RegExp("^" + cp + "+|((?:^|[^\\\\])(?:\\\\.)*)" + cp + "+$", "g"),
                cu = new RegExp("^" + cp + "*," + cp + "*"),
                cA = new RegExp("^" + cp + "*([>+~]|" + cp + ")" + cp + "*"),
                ct = new RegExp("=" + cp + "*([^\\]'\"]*?)" + cp + "*\\]", "g"),
                cR = new RegExp(ck),
                cT = new RegExp("^" + cK + "$"),
                c1 = {
                    ID: new RegExp("^#(" + b6 + ")"),
                ...
                if (c7 && !dA) {
                    if ((dz = cQ.exec(du))) {
                        if ((ds = dz[1])) {
                            ...
                            if (dz[2]) {
                                b7.apply(dy, dm.getElementsByTagName(du));
                                return dy
                            } else {
                                if ((ds = dz[3]) && dh.getElementsByClassName && dm.getElementsByClassName) {
                                    b7.apply(dy, dm.getElementsByClassName(ds));
                                    return dy
                                }
                            }
                        }
                    ...
                    if (dh.qsa && (!c2 || !c2.test(du))) {
                        ...
                        if (dv) {
                            try {
                                b7.apply(dy, dn.querySelectorAll(dv));
                                return dy
                            } catch (dt) {} finally {
                                if (!dp) {
            ...
            function cS(e) {
                return e && typeof e.getElementsByTagName !== dd && e
            }
            dh = cv.support = {};
            ...
            cY = cv.setDocument = function(dm) {
                var e, dn = dm ? dm.ownerDocument || dm : cI,
                    i = dn.defaultView;
                ...
                dh.getElementsByClassName = cO.test(dn.getElementsByClassName) && cf(function(dp) {
                ...
                if (dh.getById) {
                    ...
                    cn.filter.ID = function(dq) {
                        var dp = dq.replace(cs, c4);
                        return function(ds) {
                            var dr = typeof ds.getAttributeNode !== dd && ds.getAttributeNode("id");
                            return dr && dr.value === dp
                        }
                    }
                }
                cn.find.TAG = dh.getElementsByTagName ? function(dp, dq) {
                ...
                cn.find.CLASS = dh.getElementsByClassName && function(dq, dp) {
                    if (typeof dp.getElementsByClassName !== dd && c7) {
                ...
                if ((dh.matchesSelector = cO.test((ce = co.webkitMatchesSelector || co.mozMatchesSelector || co.oMatchesSelector || co.msMatchesSelector)))) {
                    cf(function(dp) {
                ...
                cD = e ? function(dq, dp) {
                    ...
                    if (dr & 1 || (!dh.sortDetached && dp.compareDocumentPosition(dq) === dr)) {
                    ...
                    var dw, dt = 0,
                        ...
                        du = [dp];
                    if (!dv || !ds) {
                        return dq === dn ? -1 : dp === dn ? 1 : dv ? -1 : ds ? 1 : cH ? (cd.call(cH, dq) - cd.call(cH, dp)) : 0
                    } else {
                        if (dv === ds) {
                            return ca(dq, dp)
                        }
            ...
            cv.matchesSelector = function(dm, dp) {
                ...
                dp = dp.replace(ct, "='$1']");
                if (dh.matchesSelector && c7 && (!df || !df.test(dp)) && (!c2 || !c2.test(dp))) {
                    try {
                        var i = ce.call(dm, dp);
                        if (i || dh.disconnectedMatch || dm.document && dm.document.nodeType !== 11) {
                            return i
                        }
                    } catch (dn) {}
                }
            ...
            cv.attr = function(dm, e) {
                ...
                var i = cn.attrHandle[e.toLowerCase()],
                    dn = i && cN.call(cn.attrHandle, e.toLowerCase()) ? i(dm, e, !c7) : undefined;
            ...
            cn = cv.selectors = {
                ...
                filter: {
                    ...
                    CLASS: function(e) {
                        var i = b9[e + " "];
                        return i || (i = new RegExp("(^|" + cp + ")" + e + "(" + cp + "|$)")) && b9(e, function(dm) {
                            return i.test(typeof dm.className === "string" && dm.className || typeof dm.getAttribute !== dd && dm.getAttribute("class") || "")
                        })
                    },
                        ...
                        return dq === 1 && dm === 0 ? function(dt) {
                            ...
                            if (dD) {
                                ...
                                if (e && du) {
                                    ...
                                    if (du && (dt = (dz[c9] || (dz[c9] = {}))[i]) && dt[0] === di) {
                                        dE = dt[1]
                                    } else {
                                        while ((dA = ++dB && dA && dA[dy] || (dE = dB = 0) || dw.pop())) {
                    ...
                    PSEUDO: function(dn, dm) {
                        var e, i = cn.pseudos[dn] || cn.setFilters[dn.toLowerCase()] || cv.error("unsupported pseudo: " + dn);
                        if (i[c9]) {
                            return i(dm)
                        }
                        if (i.length > 1) {
                ...
                return cj(function(dB, dy, dt, dA) {
                    ...
                    if (dB) {
                        if (dq || dm) {
                            ...
                            dz = dx.length;
                            while (dz--) {
                                if ((dv = dx[dz]) && (dD = dq ? cd.call(dB, dv) : du[dz]) > -1) {
                                    dB[dD] = !(dy[dD] = dv)
                                }
                            }
                        }
            ...
            function da(ds) {
                var dm, dq, dn, dr = ds.length,
                    ...
                    e = [function(dy, dx, i) {
                        return (!dv && (i || dx !== dl)) || ((dm = dx).nodeType ? dt(dy, dx, i) : du(dy, dx, i))
                    }];
                for (; dp < dr; dp++) {
                    if ((dq = cn.relative[ds[dp].type])) {
                        e = [cq(dk(e), dq)]
                    } else {
                        dq = cn.filter[ds[dp].type].apply(null, ds[dp].matches);
                        if (dq[c9]) {
                            dn = ++dp;
                            for (; dn < dr; dn++) {
                            ...
                            return cg(dp > 1 && dk(e), dp > 1 && ci(ds.slice(0, dp - 1).concat({
                                value: ds[dp - 2].type === " " ? "*" : ""
                            })).replace(cr, "$1"), dq, dp < dn && da(ds.slice(dp, dn)), dn < dr && da((ds = ds.slice(dn))), dn < dr && ci(ds))
                        }
                        e.push(dq)
                    }
                }
                ...
                var e = dm.length > 0,
                    ...
                    i = function(dz, dt, dy, dx, dC) {
                        var du, dv, dA, dE = 0,
                            ...
                            dF = [],
                            dD = dl,
                            ds = dz || dp && cn.find.TAG("*", dC),
                            dr = (di += dD == null ? 1 : Math.random() || 0.1),
                            dB = ds.length;
                        if (dC) {
                            dl = dt !== cB && dt
                        }
            ...
            function dg(dn, e, dp, ds) {
                ...
                if (!ds) {
                    if (dr.length === 1) {
                        ...
                        if (du.length > 2 && (dm = du[0]).type === "ID" && dh.getById && e.nodeType === 9 && c7 && cn.relative[du[1].type]) {
                            e = (cn.find.ID(dm.matches[0].replace(cs, c4), e) || [])[0];
                            if (!e) {
                                return dp
                            }
                        ...
                        while (dq--) {
                            ...
                            if ((dt = cn.find[dv])) {
                                if ((ds = dt(dm.matches[0].replace(cs, c4), c0.test(du[0].type) && cS(e.parentNode) || e))) {
                                    du.splice(dq, 1);
                                    dn = ds.length && ci(du);
                                    if (!dn) {
                                        b7.apply(dp, ds);
    ...
    bI.filter = function(b7, e, b6) {
        ...
        return e.length === 1 && i.nodeType === 1 ? bI.find.matchesSelector(i, b7) ? [i] : [] : bI.find.matches(b7, bI.grep(e, function(b8) {
    ...
    bI.fn.extend({
        ...
        is: function(e) {
            return !!aR(this, typeof e === "string" && z.test(e) ? bI(e) : e || [], false).length
        }
    });
    var y, n = a5.document,
        bt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        bV = bI.fn.init = function(e, b6) {
            var i, b7;
            if (!e) {
                return this
            }
            if (typeof e === "string") {
                ...
                if (e.nodeType) {
                    ...
                    if (bI.isFunction(e)) {
                        return typeof y.ready !== "undefined" ? y.ready(e) : e(bI)
                    }
                }
            }
    ...
    bI.extend({
        dir: function(b6, i, b8) {
            var e = [],
                b7 = b6[i];
            while (b7 && b7.nodeType !== 9 && (b8 === undefined || b7.nodeType !== 1 || !bI(b7).is(b8))) {
                if (b7.nodeType === 1) {
                    e.push(b7)
                }
                b7 = b7[i]
    ...
    bI.fn.extend({
        ...
        closest: function(b9, b8) {
            var ca, b7 = 0,
                b6 = this.length,
                e = [],
                cb = z.test(b9) || typeof b9 !== "string" ? bI(b9, b8 || this.context) : 0;
            for (; b7 < b6; b7++) {
    ...
    bI.Callbacks = function(ce) {
        ce = typeof ce === "string" ? (b2[ce] || af(ce)) : bI.extend({}, ce);
        var b8, b7, e, b9, ca, b6, cb = [],
            ...
            cd = {
                ...
                remove: function() {
                    if (cb) {
                        bI.each(arguments, function(ch, cf) {
                            var cg;
                            while ((cg = bI.inArray(cf, cb, cg)) > -1) {
                                cb.splice(cg, 1);
                                if (b8) {
                                    if (cg <= b9) {
                                        b9--
                ...
                has: function(cf) {
                    return cf ? bI.inArray(cf, cb) > -1 : !!(cb && cb.length)
                },
                empty: function() {
                    cb = [];
                    b9 = 0;
    ...
    bI.extend({
        Deferred: function(b6) {
            var i = [
                ...
                b8 = {
                    ...
                    then: function() {
                        var b9 = arguments;
                        return bI.Deferred(function(ca) {
                            bI.each(i, function(cc, cb) {
                                var cd = bI.isFunction(b9[cc]) && b9[cc];
                                e[cb[1]](function() {
                                    var ce = cd && cd.apply(this, arguments);
                                    if (ce && bI.isFunction(ce.promise)) {
                    ...
                    promise: function(b9) {
                        return b9 != null ? bI.extend(b9, b8) : b8
                    }
                },
                e = {};
            b8.pipe = b8.then;
        ...
        when: function(b9) {
            var b7 = 0,
                cb = O.call(arguments),
                e = cb.length,
                b6 = e !== 1 || (b9 && bI.isFunction(b9.promise)) ? e : 0,
                ce = b6 === 1 ? b9 : bI.Deferred(),
        ...
        if (!ak) {
            ...
            if (n.readyState === "complete") {
                ...
                if (n.addEventListener) {
                    ...
                    var b7 = false;
                    try {
                        b7 = a5.frameElement == null && n.documentElement
                    } catch (b6) {}
                    if (b7 && b7.doScroll) {
                        (function i() {
                            if (!bI.isReady) {
    ...
    bI.acceptData = function(b6) {
        var i = bI.noData[(b6.nodeName + " ").toLowerCase()],
            e = +b6.nodeType || 1;
    ...
    function bA(b7, b6, b8) {
        if (b8 === undefined && b7.nodeType === 1) {
            var i = "data-" + b6.replace(aQ, "-$1").toLowerCase();
            b8 = b7.getAttribute(i);
            if (typeof b8 === "string") {
                try {
                    b8 = b8 === "true" ? true : b8 === "false" ? false : b8 === "null" ? null : +b8 + "" === b8 ? +b8 : by.test(b8) ? bI.parseJSON(b8) : b8
                } catch (b9) {}
                bI.data(b7, b6, b8)
            } else {
                b8 = undefined
    ...
    function bc(b7, i, b9, b8) {
        ...
        var cb, ca, cc = bI.expando,
            cd = b7.nodeType,
            e = cd ? bI.cache : b7,
            b6 = cd ? b7[cc] : b7[cc] && cc;
        if ((!b6 || !e[b6] || (!b8 && !e[b6].data)) && b9 === undefined && typeof i === "string") {
            return
        }
        if (!b6) {
            if (cd) {
    ...
    function ab(b9, b7, e) {
        ...
        var cb, b8, ca = b9.nodeType,
            b6 = ca ? bI.cache : b9,
            cc = ca ? b9[bI.expando] : bI.expando;
        if (!b6[cc]) {
            return
        }
        if (b7) {
    ...
    bI.extend({
        queue: function(b6, i, b7) {
            ...
            if (b6) {
                ...
                if (b7) {
                    if (!e || bI.isArray(b7)) {
                        e = bI._data(b6, i, bI.makeArray(b7))
                    } else {
                        e.push(b7)
                    }
                }
        ...
        dequeue: function(b9, b8) {
            b8 = b8 || "fx";
            var i = bI.queue(b9, b8),
                ca = i.length,
                b7 = i.shift(),
                e = bI._queueHooks(b9, b8),
                b6 = function() {
                    bI.dequeue(b9, b8)
                };
            if (b7 === "inprogress") {
        ...
        _queueHooks: function(b6, i) {
            var e = i + "queueHooks";
            return bI._data(b6, e) || bI._data(b6, e, {
                empty: bI.Callbacks("once memory").add(function() {
                    bI._removeData(b6, i + "queue");
                    bI._removeData(b6, e)
                })
            })
        }
    ...
    (function() {
        var b6 = n.createDocumentFragment(),
    ...
    bI.event = {
        ...
        add: function(b8, cd, ci, ca, b9) {
            var cb, cj, ck, b6, cf, cc, ch, b7, cg, e, i, ce = bI._data(b8);
            if (!ce) {
                return
            }
            if (ci.handler) {
            ...
            if (!(cc = ce.handle)) {
                cc = ce.handle = function(cl) {
                    return typeof bI !== aC && (!cl || bI.event.triggered !== cl.type) ? bI.event.dispatch.apply(cc.elem, arguments) : undefined
                };
                cc.elem = b8
            }
            cd = (cd || "").match(aF) || [""];
            ...
            while (ck--) {
                ...
                ch = bI.extend({
                    ...
                    guid: ci.guid,
                    selector: b9,
                    needsContext: b9 && bI.expr.match.needsContext.test(b9),
                    namespace: e.join(".")
                }, b6);
                if (!(b7 = cj[cg])) {
                    b7 = cj[cg] = [];
        ...
        remove: function(b7, cd, ck, b8, cc) {
            var ca, ch, cb, b9, cj, ci, cf, b6, cg, e, i, ce = bI.hasData(b7) && bI._data(b7);
            if (!ce || !(ci = ce.events)) {
                return
            }
            cd = (cd || "").match(aF) || [""];
            ...
            while (cj--) {
                ...
                if (!cg) {
                    for (cg in ci) {
                        bI.event.remove(b7, cg + cd[cj], ck, b8, true)
                    }
                    continue
                }
                cf = bI.event.special[cg] || {};
                ...
                while (ca--) {
                    ch = b6[ca];
                    if ((cc || i === ch.origType) && (!ck || ck.guid === ch.guid) && (!cb || cb.test(ch.namespace)) && (!b8 || b8 === ch.selector || b8 === "**" && ch.selector)) {
                        b6.splice(ca, 1);
                        if (ch.selector) {
                            b6.delegateCount--
                        }
        ...
        trigger: function(b6, cd, b9, ck) {
            var ce, b8, ci, cj, cg, cc, cb, ca = [b9 || n],
                ch = J.call(b6, "type") ? b6.type : b6,
                b7 = J.call(b6, "namespace") ? b6.namespace.split(".") : [];
            ci = cc = b9 = b9 || n;
        ...
        dispatch: function(e) {
            ...
            var b9, ca, ce, b6, b8, cd = [],
                cc = O.call(arguments),
                b7 = (bI._data(this, "events") || {})[e.type] || [],
    ...
    if (!C.submitBubbles) {
        bI.event.special.submit = {
            setup: function() {
                ...
                bI.event.add(this, "click._submit keypress._submit", function(b7) {
                    var b6 = b7.target,
                        i = bI.nodeName(b6, "input") || bI.nodeName(b6, "button") ? b6.form : undefined;
                    if (i && !bI._data(i, "submitBubbles")) {
                        bI.event.add(i, "submit._submit", function(e) {
    ...
    if (!C.changeBubbles) {
        bI.event.special.change = {
            setup: function() {
                ...
                bI.event.add(this, "beforeactivate._change", function(b6) {
                    var i = b6.target;
                    if (bG.test(i.nodeName) && !bI._data(i, "changeBubbles")) {
                        bI.event.add(i, "change._change", function(e) {
    ...
    if (!C.focusinBubbles) {
        bI.each({
            ...
            var i = function(b7) {
                bI.event.simulate(e, b7.target, bI.event.fix(b7), true)
            };
            bI.event.special[e] = {
                setup: function() {
    ...
    function l(b8, e) {
        var b6, b9, b7 = 0,
            ca = typeof b8.getElementsByTagName !== aC ? b8.getElementsByTagName(e || "*") : typeof b8.querySelectorAll !== aC ? b8.querySelectorAll(e || "*") : undefined;
        if (!ca) {
    ...
    function S(b8, i) {
        ...
        if (b9 === "script" && i.text !== b8.text) {
            ...
            if (b9 === "object") {
                ...
                if (C.html5Clone && (b8.innerHTML && !bI.trim(i.innerHTML))) {
    ...
    bI.extend({
        clone: function(b6, b8, e) {
            ...
            if (C.html5Clone || bI.isXMLDoc(b6) || !L.test("<" + b6.nodeName + ">")) {
                cd = b6.cloneNode(true)
            } else {
                k.innerHTML = b6.outerHTML;
                k.removeChild(cd = k.firstChild)
            }
            if ((!C.noCloneEvent || !C.noCloneChecked) && (b6.nodeType === 1 || b6.nodeType === 11) && !bI.isXMLDoc(b6)) {
                ca = l(cd);
                cb = l(b6);
                for (b9 = 0;
                    (b7 = cb[b9]) != null; ++b9) {
                ...
                if (ca || ca === 0) {
                    if (bI.type(ca) === "object") {
                        ...
                        if (!K.test(ca)) {
                            ...
                            if (!C.leadingWhitespace && b5.test(ca)) {
    ...
    bI.fn.extend({
        text: function(e) {
            return aB(this, function(i) {
                return i === undefined ? bI.text(this) : this.empty().append((this[0] && this[0].ownerDocument || n).createTextNode(i))
        ...
        remove: function(e, b9) {
            var b8, b6 = e ? bI.filter(e, this) : this,
                b7 = 0;
            for (;
                (b8 = b6[b7]) != null; b7++) {
                if (!b9 && b8.nodeType === 1) {
        ...
        html: function(e) {
            return aB(this, function(b9) {
                ...
                if (typeof b9 === "string" && !an.test(b9) && (C.htmlSerialize || !L.test(b9)) && (C.leadingWhitespace || !b5.test(b9)) && !V[(o.exec(b9) || ["", ""])[1].toLowerCase()]) {
                    b9 = b9.replace(aH, "<$1></$2>");
                    try {
                        for (; b7 < b6; b7++) {
                            b8 = this[b7] || {};
                            if (b8.nodeType === 1) {
                                bI.cleanData(l(b8, false));
                                b8.innerHTML = b9
                            }
                        }
                        b8 = 0
        ...
        domManip: function(cd, ci) {
            ...
            var cb, b7, e, b9, cg, cc, ca = 0,
                ...
                ce = cd[0],
                b6 = bI.isFunction(ce);
            if (b6 || (b8 > 1 && typeof ce === "string" && !C.checkClone && bW.test(ce))) {
                return this.each(function(cj) {
                    var i = cf.eq(cj);
                    if (b6) {
                        cd[0] = ce.call(this, cj, i.html())
                    }
                    i.domManip(cd, ci)
                })
            }
    ...
    function a4(e, b7) {
        var i = bI(b7.createElement(e)).appendTo(b7.body),
            b6 = a5.getDefaultComputedStyle ? a5.getDefaultComputedStyle(i[0]).display : bI.css(i[0], "display");
        i.detach();
        return b6
    }
    ...
    function a0(b6) {
        ...
        if (!e) {
            e = a4(b6, i);
            if (e === "none" || !e) {
                aI = (aI || bI("<iframe frameborder='0' width='0' height='0'/>")).appendTo(i.documentElement);
        ...
        var e, b6, b7 = n.createElement("div"),
        ...
        C.shrinkWrapBlocks = function() {
            ...
            if (b6 == null) {
                ...
                if (typeof cb.style.zoom !== aC) {
                    cb.style.cssText = i + ";width:1px;padding:1px;zoom:1";
    ...
    if (a5.getComputedStyle) {
        ...
        F = function(cb, i, ca) {
            ...
            if (ca) {
                if (e === "" && !bI.contains(cb.ownerDocument, cb)) {
                    e = bI.style(cb, i)
                }
    ...
    function a7(e, i) {
        ...
        var cb, cd, b6, ca, b9, cc, i = n.createElement("div"),
            e = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px",
            b8 = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
        ...
        bI.extend(C, {
            reliableHiddenOffsets: function() {
                ...
                var cf, ch, cg, ci = n.createElement("div"),
            ...
            reliableMarginRight: function() {
                var ce, cf, ch, cg;
                if (cc == null && a5.getComputedStyle) {
                    ce = n.getElementsByTagName("body")[0];
                    if (!ce) {
                        return
                    }
        ...
        for (; b6 < b7; b6++) {
            ...
            if (e) {
                ...
                if (b8.style.display === "" && R(b8)) {
                    i[b6] = bI._data(b8, "olddisplay", a0(b8.nodeName))
                }
            } else {
                if (!i[b6]) {
                    b9 = R(b8);
                    if (cb && cb !== "none" || !b9) {
                        bI._data(b8, "olddisplay", b9 ? cb : bI.css(b8, "display"))
                    }
                }
            }
        }
    ...
    function u(b8, i, e) {
        var b7 = true,
            b9 = i === "width" ? b8.offsetWidth : b8.offsetHeight,
            b6 = bq(b8),
            ca = C.boxSizing() && bI.css(b8, "boxSizing", false, b6) === "border-box";
        if (b9 <= 0 || b9 == null) {
            b9 = F(b8, i, b6);
            if (b9 < 0 || b9 == null) {
                b9 = b8.style[i]
    ...
    bI.extend({
        ...
        style: function(b7, b6, cd, b8) {
            ...
            var cb, cc, ce, b9 = bI.camelCase(b6),
                i = b7.style;
            ...
            if (cd !== undefined) {
                ...
                if (cc === "string" && (cb = U.exec(cd))) {
                    cd = (cb[1] + 1) * cb[2] + parseFloat(bI.css(b7, b6));
                    cc = "number"
                }
                if (cd == null || cd !== cd) {
                    return
                }
                if (cc === "number" && !bI.cssNumber[b9]) {
                    cd += "px"
                }
    ...
    bI.each(["height", "width"], function(b6, e) {
        bI.cssHooks[e] = {
            get: function(b8, b7, i) {
                if (b7) {
                    return b8.offsetWidth === 0 && G.test(bI.css(b8, "display")) ? bI.swap(b8, be, function() {
                        return u(b8, e, i)
                    }) : u(b8, e, i)
                }
            },
    ...
    if (!C.opacity) {
        bI.cssHooks.opacity = {
            get: function(i, e) {
                return aU.test((e && i.currentStyle ? i.currentStyle.filter : i.style.filter) || "") ? (0.01 * parseFloat(RegExp.$1)) + "" : e ? "1" : ""
            },
            set: function(b8, b9) {
                var b7 = b8.style,
                    i = b8.currentStyle,
                    e = bI.isNumeric(b9) ? "alpha(opacity=" + b9 * 100 + ")" : "",
                    b6 = i && i.filter || b7.filter || "";
                b7.zoom = 1;
                if ((b9 >= 1 || b9 === "") && bI.trim(b6.replace(bj, "")) === "" && b7.removeAttribute) {
    ...
    bI.cssHooks.marginRight = a7(C.reliableMarginRight, function(i, e) {
        if (e) {
            return bI.swap(i, {
    ...
    bI.each({
        ...
        bI.cssHooks[e + i] = {
            expand: function(b8) {
                ...
                for (; b7 < 4; b7++) {
                    b6[e + bT[b7] + i] = b9[b7] || b9[b7 - 2] || b9[0]
                }
                return b6
            }
        };
        ...
        css: function(e, i) {
            return aB(this, function(ca, b7, cb) {
                ...
                if (bI.isArray(b7)) {
                    ...
                    b6 = b7.length;
                    for (; b8 < b6; b8++) {
                        cc[b7[b8]] = bI.css(ca, b7[b8], false, b9)
                    }
                    return cc
                }
    ...
    I.prototype = {
        ...
        run: function(b6) {
            ...
            if (this.options.duration) {
                this.pos = i = bI.easing[this.easing](b6, this.options.duration * b6, 0, 1, this.options.duration)
            } else {
                this.pos = i = b6
            }
    ...
    bI.fx.step = {};
    var M, ae, bR = /^(?:toggle|show|hide)$/,
        bJ = new RegExp("^(?:([+-])=|)(" + aE + ")([a-z%]*)$", "i"),
        bP = /queueHooks$/,
        aG = [h],
        a2 = {
            "*": [function(e, ca) {
                var cc = this.createTween(e, ca),
                    b8 = cc.cur(),
                    b7 = bJ.exec(ca),
                    cb = b7 && b7[3] || (bI.cssNumber[e] ? "" : "px"),
                    i = (bI.cssNumber[e] || cb !== "px" && +b8) && bJ.exec(bI.css(cc.elem, e)),
                    b6 = 1,
                    b9 = 20;
                if (i && i[3] !== cb) {
                    cb = cb || i[3];
    ...
    function h(b7, cd, e) {
        var b6, cf, ca, ci, cj, cg, cc, b9, b8 = this,
            ce = {},
            i = b7.style,
            cb = b7.nodeType && R(b7),
        ...
        if (b7.nodeType === 1 && ("height" in cd || "width" in cd)) {
            ...
            if (cc === "inline" && bI.css(b7, "float") === "none") {
                if (!C.inlineBlockNeedsLayout || b9 === "inline") {
    ...
    function f(b6, ca, cd) {
        var ce, e, b9 = 0,
            i = aG.length,
            cc = bI.Deferred().always(function() {
                delete b8.elem
            }),
            b8 = function() {
                if (e) {
            ...
            b7 = cc.promise({
                ...
                createTween: function(ch, cf) {
                    var cg = bI.Tween(b6, b7.opts, ch, cf, b7.opts.specialEasing[ch] || b7.opts.easing);
                    b7.tweens.push(cg);
                    return cg
                },
                stop: function(cg) {
    ...
    bI.speed = function(b6, b7, i) {
        var e = b6 && typeof b6 === "object" ? bI.extend({}, b6) : {
            complete: i || !i && b7 || bI.isFunction(b6) && b6,
            duration: b6,
            easing: i && b7 || b7 && !bI.isFunction(b7) && b7
        };
        ...
        stop: function(b6, i, e) {
            ...
            return this.each(function() {
                ...
                if (b8) {
                    ...
                    for (b8 in b9) {
                        if (b9[b8] && b9[b8].stop && bP.test(b8)) {
                            b7(b9[b8])
                        }
                    }
                }
    ...
    bI.each(["toggle", "show", "hide"], function(b6, e) {
        ...
        bI.fn[e] = function(i, b9, b8) {
            return i == null || typeof i === "boolean" ? b7.apply(this, arguments) : this.animate(bH(e, true), i, b9, b8)
        }
    });
    bI.each({
        slideDown: bH("show"),
    ...
    bI.fn.extend({
        val: function(b7) {
            ...
            if (!arguments.length) {
                if (b6) {
                    e = bI.valHooks[b6.type] || bI.valHooks[b6.nodeName.toLowerCase()];
                    if (e && "get" in e && (i = e.get(b6, "value")) !== undefined) {
                        return i
                    }
                    i = b6.value;
            ...
            return this.each(function(b9) {
                ...
                if (b8) {
                    ca = b7.call(this, b9, bI(this).val())
                } else {
                    ca = b7
                }
                if (ca == null) {
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    for (; b6 < ca; b6++) {
                        b7 = cd[b6];
                        if ((b7.selected || b6 === b9) && (C.optDisabled ? !b7.disabled : b7.getAttribute("disabled") === null) && (!b7.parentNode.disabled || !bI.nodeName(b7.parentNode, "optgroup"))) {
                            cb = bI(b7).val();
                            if (b8) {
                                return cb
                            }
    ...
    var ba, b3, bO = bI.expr.attrHandle,
        aq = /^(?:checked|selected)$/i,
        bN = C.getSetAttribute,
        bF = C.input;
    bI.fn.extend({
        attr: function(e, i) {
            return aB(this, bI.attr, e, i, arguments.length > 1)
        },
    ...
    bI.extend({
        ...
        attrHooks: {
            type: {
                set: function(e, i) {
                    if (!C.radioValue && i === "radio" && bI.nodeName(e, "input")) {
                        var b6 = e.value;
    ...
    b3 = {
        set: function(i, b6, e) {
            if (b6 === false) {
                ...
                if (bF && bN || !aq.test(e)) {
                    i.setAttribute(!bN && bI.propFix[e] || e, e)
                } else {
    ...
    bI.each(bI.expr.match.bool.source.match(/\w+/g), function(b7, b6) {
        ...
        bO[b6] = bF && bN || !aq.test(b6) ? function(b9, b8, cb) {
            var i, ca;
            if (!cb) {
                ca = bO[b8];
                bO[b8] = i;
            ...
            if (!b9) {
                return b8[bI.camelCase("default-" + i)] ? i.toLowerCase() : null
            }
        }
    });
    if (!bF || !bN) {
    ...
    if (!bN) {
        ba = {
            set: function(b6, b7, i) {
                ...
                if (!e) {
                    b6.setAttributeNode((e = b6.ownerDocument.createAttribute(i)))
                }
                e.value = b7 += "";
        ...
        bO.id = bO.name = bO.coords = function(b6, i, b7) {
            var e;
            if (!b7) {
                return (e = b6.getAttributeNode(i)) && e.value !== "" ? e.value : null
            }
        };
        bI.valHooks.button = {
            get: function(b6, i) {
    ...
    bI.fn.extend({
        prop: function(e, i) {
            return aB(this, bI.prop, e, i, arguments.length > 1)
        },
    ...
    bI.fn.extend({
        addClass: function(cd) {
            var b7, b6, ce, cb, b8, e, b9 = 0,
                ca = this.length,
                cc = typeof cd === "string" && cd;
            if (bI.isFunction(cd)) {
                return this.each(function(i) {
                    bI(this).addClass(cd.call(this, i, this.className))
                })
            }
            if (cc) {
                b7 = (cd || "").match(aF) || [];
        ...
        removeClass: function(cd) {
            ...
            if (bI.isFunction(cd)) {
                return this.each(function(i) {
                    bI(this).removeClass(cd.call(this, i, this.className))
                })
            }
            if (cc) {
                b7 = (cd || "").match(aF) || [];
        ...
        toggleClass: function(b6, e) {
            ...
            if (bI.isFunction(b6)) {
                return this.each(function(b7) {
                    bI(this).toggleClass(b6.call(this, b7, this.className, e), e)
                })
            }
            return this.each(function() {
                if (i === "string") {
    ...
    bI.each(("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu").split(" "), function(b6, e) {
        bI.fn[e] = function(b7, i) {
            return arguments.length > 0 ? this.on(e, null, b7, i) : this.trigger(e)
        }
    });
    bI.fn.extend({
        hover: function(e, i) {
        ...
        undelegate: function(e, i, b6) {
            return arguments.length === 1 ? this.off(e, "**") : this.off(i, e || "**", b6)
        }
    });
    var bp = bI.now();
    var bQ = (/\?/);
    ...
    bI.parseJSON = function(e) {
        ...
        var b7, b6 = null,
            i = bI.trim(e + "");
        return i && !bI.trim(i.replace(a1, function(ca, b8, b9, cb) {
            if (b7 && b8) {
                b6 = 0
            }
            if (b6 === 0) {
    ...
    bI.extend({
        ...
        ajaxSetup: function(i, e) {
            return e ? s(s(i, bI.ajaxSettings), e) : s(bI.ajaxSettings, i)
        },
        ajaxPrefilter: bK(v),
        ajaxTransport: bK(a9),
        ajax: function(ca, b7) {
            ...
            b7 = b7 || {};
            var cj, cl, cb, cq, cf, b6, cm, b8, ce = bI.ajaxSetup({}, b7),
                cs = ce.context || ce,
                ch = ce.context && (cs.nodeType || cs.jquery) ? bI(cs) : bI.event,
                cr = bI.Deferred(),
                co = bI.Callbacks("once memory"),
                cc = ce.statusCode || {},
                ci = {},
                cp = {},
                b9 = 0,
            ...
            if (!ce.hasContent) {
                ...
                if (ce.cache === false) {
                    ce.url = Q.test(cb) ? cb.replace(Q, "$1_=" + bp++) : cb + (bQ.test(cb) ? "&" : "?") + "_=" + bp++
                }
            }
            if (ce.ifModified) {
            ...
            function cg(cw, i, cx, cu) {
                ...
                if (e) {
                    if (ce.ifModified) {
                        cz = ck.getResponseHeader("Last-Modified");
                        if (cz) {
                ...
                cc = undefined;
                if (b6) {
                    ch.trigger(e ? "ajaxSuccess" : "ajaxError", [ck, ce, e ? cA : cy])
                }
    ...
    bI.fn.extend({
        ...
        wrap: function(e) {
            ...
            return this.each(function(b6) {
                bI(this).wrapAll(i ? e.call(this, b6) : e)
            })
        },
        unwrap: function() {
    ...
    bI.expr.filters.hidden = function(e) {
        return e.offsetWidth <= 0 && e.offsetHeight <= 0 || (!C.reliableHiddenOffsets() && ((e.style && e.style.display) || bI.css(e, "display")) === "none")
    };
    ...
    function j(b6, b8, i, b7) {
        var e;
        if (bI.isArray(b8)) {
            bI.each(b8, function(ca, b9) {
                if (i || aS.test(b6)) {
                    b7(b6, b9)
                } else {
                    j(b6 + "[" + (typeof b9 === "object" ? ca : "") + "]", b9, i, b7)
                }
            })
        } else {
    ...
    bI.param = function(e, b6) {
        var b7, i = [],
            b8 = function(b9, ca) {
                ca = bI.isFunction(ca) ? ca() : (ca == null ? "" : ca);
    ...
    bI.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var b7 = bI(this).val();
                return b7 == null ? null : bI.isArray(b7) ? bI.map(b7, function(i) {
                    return {
                        name: b6.name,
                        value: i.replace(W, "\r\n")
                    }
    ...
    bI.ajaxTransport("script", function(b6) {
        if (b6.crossDomain) {
            var e, i = n.head || bI("head")[0] || n.documentElement;
            return {
                send: function(b7, b8) {
    ...
    bI.ajaxPrefilter("json jsonp", function(b7, e, b8) {
        var ca, i, b6, b9 = b7.jsonp !== false && (a8.test(b7.url) ? "url" : typeof b7.data === "string" && !(b7.contentType || "").indexOf("application/x-www-form-urlencoded") && a8.test(b7.data) && "data");
        if (b9 || b7.dataTypes[0] === "jsonp") {
            ca = b7.jsonpCallback = bI.isFunction(b7.jsonpCallback) ? b7.jsonpCallback() : b7.jsonpCallback;
            if (b9) {
                b7[b9] = b7[b9].replace(a8, "$1" + ca)
            } else {
                if (b7.jsonp !== false) {
                    b7.url += (bQ.test(b7.url) ? "&" : "?") + b7.jsonp + "=" + ca
                }
            }
            b7.converters["script json"] = function() {
                if (!b6) {
                    bI.error(ca + " was not called")
                }
                return b6[0]
            };
            b7.dataTypes[0] = "json";
    ...
    bI.offset = {
        setOffset: function(b7, ch, cb) {
            var cd, ca, e, b8, b6, cf, cg, cc = bI.css(b7, "position"),
                b9 = bI(b7),
                ce = {};
            if (cc === "static") {
    ...
    bI.fn.extend({
        offset: function(i) {
            if (arguments.length) {
                return i === undefined ? this : this.each(function(ca) {
        ...
        position: function() {
            ...
            return {
                top: b7.top - e.top - bI.css(i, "marginTop", true),
                left: b7.left - e.left - bI.css(i, "marginLeft", true)
            }
        },
    ...
    bI.each({
        ...
        bI.fn[b6] = function(b7) {
            return aB(this, function(b8, cb, ca) {
                var b9 = br(b8);
                if (ca === undefined) {
                    return b9 ? (i in b9) ? b9[i] : b9.document.documentElement[cb] : b8[cb]
                }
                if (b9) {
                    b9.scrollTo(!e ? ca : bI(b9).scrollLeft(), e ? ca : bI(b9).scrollTop())
                } else {
                    b8[cb] = ca
                }
...
(function() {
    ...
    k.getListeners = function s(u) {
        ...
        if (typeof u === "object") {
            v = {};
            for (w in x) {
                if (x.hasOwnProperty(w) && u.test(w)) {
                    v[w] = x[w]
                }
            }
        } else {
    ...
    k.flattenListeners = function q(w) {
        var u = [];
        var v;
    ...
    k.getListenersAsObject = function e(u) {
        var w = this.getListeners(u);
        var v;
    ...
    k.addListener = function f(u, x) {
        var w = this.getListenersAsObject(u);
        var y = typeof x === "object";
        var v;
        for (v in w) {
            if (w.hasOwnProperty(v) && h(w[v], x) === -1) {
                w[v].push(y ? x : {
                    listener: x,
                    once: false
                })
    ...
    k.on = k.addListener;
    k.addOnceListener = function a(u, v) {
        return this.addListener(u, {
            listener: v,
            once: true
        })
    };
    k.once = k.addOnceListener;
    k.defineEvent = function o(u) {
        this.getListeners(u);
        return this
    };
    k.defineEvents = function p(u) {
        for (var v = 0; v < u.length; v += 1) {
            this.defineEvent(u[v])
        }
        return this
    };
    k.removeListener = function b(u, y) {
        var x = this.getListenersAsObject(u);
        var v;
        var w;
        for (w in x) {
    ...
    k.off = k.removeListener;
    k.addListeners = function l(u, v) {
        return this.manipulateListeners(false, u, v)
    };
    k.removeListeners = function r(u, v) {
        return this.manipulateListeners(true, u, v)
    };
    k.manipulateListeners = function g(v, w, y) {
        var x;
        var z;
        var A = v ? this.removeListener : this.addListener;
        var u = v ? this.removeListeners : this.addListeners;
        if (typeof w === "object" && !(w instanceof RegExp)) {
            for (x in w) {
                if (w.hasOwnProperty(x) && (z = w[x])) {
    ...
    k.removeEvent = function n(u) {
        var x = typeof u;
        var w = this._getEvents();
        var v;
        if (x === "string") {
            delete w[u]
        } else {
            if (x === "object") {
                for (v in w) {
                    if (w.hasOwnProperty(v) && u.test(v)) {
                        delete w[v]
                    }
                }
            } else {
    ...
    k.emitEvent = function t(u, w) {
        var z = this.getListenersAsObject(u);
        var A;
        var y;
        var x;
        var v;
        for (x in z) {
            if (z.hasOwnProperty(x)) {
                ...
                while (y--) {
                    A = z[x][y];
                    v = A.listener.apply(this, w || []);
                    if (v === this._getOnceReturnValue() || A.once === true) {
                        this.removeListener(u, z[x][y].listener)
                    }
                }
            }
        }
    ...
    k.trigger = k.emitEvent;
    k.emit = function j(u) {
        var v = Array.prototype.slice.call(arguments, 1);
        return this.emitEvent(u, v)
    };
    k.setOnceReturnValue = function i(u) {
        this._onceReturnValue = u;
        return this
    };
    k._getOnceReturnValue = function m() {
...
(function(d) {
    ...
    var a = ["color", "backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "outlineColor"];
    d.each(a, function(f, g) {
        d.Tween.propHooks[g] = {
            get: function(h) {
                return d(h.elem).css(g)
            },
            set: function(i) {
                var j = i.elem.style;
                var k = b(d(i.elem).css(g));
                var h = b(i.end);
                i.run = function(l) {
                    j[g] = c(k, h, l)
                }
    ...
    d.Tween.propHooks.borderColor = {
        set: function(g) {
            ...
            d.each(i, function(k, l) {
                j[l] = b(d(g.elem).css(l))
            });
            var f = b(g.end);
            g.run = function(k) {
                d.each(i, function(l, m) {
                    h[m] = c(j[m], f, k)
                })
            }
        }
    ...
    function c(h, f, i) {
        var g = "rgb" + (d.support.rgba ? "a" : "") + "(" + parseInt((h[0] + i * (f[0] - h[0])), 10) + "," + parseInt((h[1] + i * (f[1] - h[1])), 10) + "," + parseInt((h[2] + i * (f[2] - h[2])), 10);
        if (d.support.rgba) {
            g += "," + (h && f ? parseFloat(h[3] + i * (f[3] - h[3])) : 1)
        }
        g += ")";
        return g
    }
    ...
    function b(f) {
        var g, h;
        if (g = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(f)) {
            h = [parseInt(g[1], 16), parseInt(g[2], 16), parseInt(g[3], 16), 1]
        } else {
            if (g = /#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/.exec(f)) {
                h = [parseInt(g[1], 16) * 17, parseInt(g[2], 16) * 17, parseInt(g[3], 16) * 17, 1]
            } else {
                if (g = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(f)) {
                    h = [parseInt(g[1]), parseInt(g[2]), parseInt(g[3]), 1]
                } else {
                    if (g = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]*)\s*\)/.exec(f)) {
                        h = [parseInt(g[1], 10), parseInt(g[2], 10), parseInt(g[3], 10), parseFloat(g[4])]
                    }
                }
            }
        }
...
(function(b) {
    var a = {
        init: function(c) {
            return this.each(function() {
                var d = b.extend({
                    ...
                    maxDull: 0.7,
                    glowInterval: 4000,
                    glowIntervalVariation: 400,
                    dullInterval: 6000,
                    dullIntervalVariation: 600,
                    autoStart: 1
                }, c);
                b(this).data("glow", d);
                d.self = this;
        ...
        start: function() {
            var c = b(this).data("glow");
            a.makeElementGlow.call(c.self)
        },
        makeElementGlow: function() {
            var g = b(this).data("glow");
            if (typeof g.$self.data("lastTime") == "undefined") {
                g.$self.data("lastTime", g.glowIntervalVariation / 2)
            }
            var h = g.glowInterval - g.$self.data("lastTime"),
                e = g.glowInterval - g.$self.data("lastTime") + g.glowIntervalVariation,
                f = randomNumber(h, e),
                d = randomNumber(g.minGlow, g.maxGlow),
                c = g.$self.data("lastTime") + f - g.glowInterval;
            if (!b.support.transition) {
                g.$self.stop().data("lastTime", c).animate({
                    opacity: d
                }, f, function() {
                    a.makeElementDull.call(g.self)
                })
            } else {
                g.$self.data("lastTime", c).transition({
                    opacity: d
                }, f, function() {
                    a.makeElementDull.call(g.self)
                })
        ...
        makeElementDull: function() {
            var h = b(this).data("glow");
            if (typeof h.$self.data("lastTime") == "undefined") {
                h.$self.data("lastTime", h.dullIntervalVariation / 2)
            }
            var g = h.dullInterval - h.$self.data("lastTime"),
                d = h.dullInterval - h.$self.data("lastTime") + h.dullIntervalVariation,
                f = randomNumber(g, d),
                e = randomNumber(h.minDull, h.maxDull),
                c = h.$self.data("lastTime") + f - h.dullInterval;
            if (!b.support.transition) {
                h.$self.stop().animate({
                    opacity: e
                }, f, function() {
                    a.makeElementGlow.call(h.self)
                })
            } else {
                h.$self.transition({
                    opacity: e
    ...
    var a = {
        init: function(c) {
            return this.each(function() {
                ...
                b(this).data("rollElement", d);
                d.self = this;
                d.$self = b(d.self);
                d.isForward = (d.orientation == "forward");
                d.initialPos = (d.isForward) ? -d.rollSize : 0;
                d.finalPos = (d.isForward) ? 0 : -d.rollSize;
                d.isVertical = (d.direction == "vertical");
                if (d.autoStart) {
                    a.start.call(d.self)
                }
            })
        ...
        start: function() {
            var c = b(this).data("rollElement");
            a.startRolling.call(c.self)
        },
...
function Timer(c, a, b) {
    ...
    d.pause = function() {
        window.clearTimeout(d.timer);
        d.remainingTime -= new Date() - d.startTime
    };
    d.cancel = function() {
        d.remainingTime = 0;
        window.clearTimeout(d.timer)
    ...
    b.formatResult = function(e, f) {
        var h = e.value.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
    ...
    b.prototype = {
        ...
        initialize: function() {
            ...
            h.el.on("change.autocomplete", function(j) {
                h.onKeyUp(j)
            });
            h.el.on("input.autocomplete", function(j) {
                h.onKeyUp(j)
            })
        },
        onFocus: function() {
        ...
        getSuggestionsLocal: function(k) {
            var i = this,
                ...
                j;
            j = {
                suggestions: d.grep(g.lookup, function(l) {
                    return h(l, k, f)
                })
            };
        ...
        suggest: function() {
            ...
            d.each(k.suggestions, function(s, r) {
                if (o) {
                    i += h(r, n, s)
                }
        ...
        findBestHint: function() {
            ...
            d.each(f.suggestions, function(j, h) {
...
(function(b) {
    var a = {
        init: function(c) {
            return this.each(function() {
                ...
                b(this).data("floatingMessage", d);
                d.self = this;
                d.$self = b(d.self);
                d.$closeButton = b("#" + d.$self.attr("id") + "c");
                d.$closeButton.css("display", "block");
                d.$picture = b("#" + d.$self.attr("id") + "p");
                b("#" + d.$self.attr("id") + "t").css("margin-right", "8.25em");
                d.separation = (d.$self.outerHeight() - d.$self.height()) / 2;
                d.state = "hidden";
                b(window).resize(a.resize);
                if (d.autoStart) {
                    a.start.call(d.self)
                }
            })
        ...
        start: function() {
            var c = b(this).data("floatingMessage");
            c.$self.css({
                opacity: 0
            });
            c.$picture.click(function(d) {
                if (c.state == "hidden" || c.state == "hiding") {
                    d.preventDefault();
                    a.show.call(c.self)
                }
            });
            c.$closeButton.css("opacity", 1).click(function(d) {
                d.preventDefault();
                a.hide.call(c.self)
            });
            if (localStorage.getItem("floatingMessageDismissed") !== null && localStorage.getItem("floatingMessageDismissed") == "true") {
                c.$picture.css({
                    opacity: 0,
                    marginBottom: -(c.separation / 2) + "px",
                    marginRight: -(c.separation / 2) + "px"
                });
                c.$picture.stop().animate({
                    opacity: 1
                }, 400)
            } else {
                c.$picture.css({
                    opacity: 0,
                    marginBottom: -(c.$picture.outerHeight() - c.separation) + "px",
                    marginRight: (c.$closeButton.outerWidth() + c.separation * 2) + "px"
                });
                a.show.call(c.self)
            }
        },
        show: function() {
            var d = b(this).data("floatingMessage");
            d.state = "showing";
            d.$self.stop().animate({
                opacity: 1
            }, 400);
            var c = b(document).width() > 480 ? d.separation / 3 : d.separation;
            d.$picture.stop();
            if (d.$picture.css("opacity") == 0) {
                d.$picture.delay(400)
            }
            d.$picture.animate({
                opacity: 1,
                marginBottom: c + "px",
                marginRight: (d.$closeButton.outerWidth() + d.separation * 2) + "px"
            }, {
                duration: 400,
                easing: "easeOutCubic",
                complete: function() {
            ...
            localStorage.setItem("floatingMessageDismissed", "false")
        },
        hide: function() {
            var c = b(this).data("floatingMessage");
            c.state = "hiding";
            ...
            localStorage.setItem("floatingMessageDismissed", "true")
        },
        resize: function(d) {
            var c = b(this).data("floatingMessage");
            c.separation = (c.$self.outerHeight() - c.$self.height()) / 2;
            if (c.state == "hidden" || c.state == "hiding") {
                a.hide.call(c.self)
            } else {
                a.show.call(c.self)
    ...
    b.fn.floatingMessage = function(c) {
        if (a[c]) {
            return a[c].apply(this, Array.prototype.slice.call(arguments, 1))
        } else {
            if (typeof c === "object" || !c) {
...
var isDetailsSupported = (function(e) {
    var c = e.createElement("details"),
        b, a, d;
    if (!("open" in c)) {
        return false
    }
    a = e.body || (function() {
        ...
        b = true;
        return f.insertBefore(e.createElement("body"), f.firstElementChild || f.firstChild)
    }());
...
$(document).ready(function() {
    ...
    $("details.crossbrowser").details();
    $presentationDiv = $("#p");
    $('<img src="/newjqfs/images/pbk.jpg" style="display: none;">').appendTo($presentationDiv);
    $('<img src="/newjqfs/images/pgl.png" style="display: none;">').appendTo($presentationDiv);
    $('<img src="/newjqfs/images/pho.png" style="display: none;">').appendTo($presentationDiv);
    $('<img src="/newjqfs/images/po.jpg" style="display: none;">').appendTo($presentationDiv);
    if ($.support.opacity) {
        $("#plgc").css({
            filter: "none"
        })
    }
    $presentationDiv.imagesLoaded(function() {
        $("#bkar").rollElement();
        $("#plgc").glow();
        $("#shc").glow({
            minGlow: 0.9,
    ...
    $(".ocbtn").disableSelection();
    $("#fmsg").floatingMessage();
    $("#tbic").click(function() {
        var a = $("#tbul"),
            b = 200;
        if (a.css("opacity") == 0) {
...
function randomInt(b, a) {
    ...
    a.fn.disableSelection = function() {
        return this.attr("unselectable", "on").css("user-select", "none").on("selectstart dragstart", function(b) {
            b.preventDefault()
        })
    }
})(jQuery);
...
function ocAttrs() {
    $(".attr, .oh5attr").each(function() {
        var b = $(this),
            a = b.children(".ocbtn");
        a.mousedown(function() {
            if (b.hasClass("open")) {
                a.addClass("ocbtnup ocbtnp")
            } else {
                a.addClass("ocbtndp ocbtnp")
            }
        }).mouseup(function() {
            if (b.hasClass("open")) {
                a.removeClass("ocbtnup ocbtnp")
            } else {
                a.removeClass("ocbtndp ocbtnp")
            }
        }).click(function() {
            if (b.hasClass("open")) {
                b.removeClass("open");
                a.removeClass("ocbtnu").addClass("ocbtnd")
            } else {
                b.addClass("open");
                a.removeClass("ocbtnd").addClass("ocbtnu")
            }
        })
    })
}
...
function olTags() {
    $("#tt").children("tbody").children().each(function() {
        var c = $(this);
        if (c.children().first().is("td")) {
            var b, a = c.find("a");
            if (a.length > 0) {
                c.click(function() {
...
function olCanvas() {
    var c = $("#canvasc1"),
        a = $("#canvasc2"),
        d = $('<canvas id="canvas1" width="' + c.width() + '" height="100"></canvas>').appendTo(c),
        b = $('<canvas id="canvas2" width="' + a.width() + '" height="200"></canvas>').appendTo(a),
        e = d[0];
    canvas2 = b[0];
    context1 = e.getContext("2d"), context2 = canvas2.getContext("2d"), timer = new Timer(), speed = 8.5, gravity = 0.5, angle = 290, angleRad = angle * Math.PI / 180, radius = 12, velX = Math.cos(angleRad) * speed, velY = Math.sin(angleRad) * speed, ball = {
        x: radius + 1,
        y: e.height - radius,
        velX: velX,
        velY: velY,
        radius: radius
    }, dotsX = new Array(), dotsY = new Array(), line = new Array(), paint = false, drawCanvas1 = function() {
        context1.fillStyle = "#fff";
        context1.fillRect(0, 0, e.width, e.height);
        context1.strokeStyle = "#000";
        ball.velY += gravity;
        if ((ball.y + ball.radius) >= e.height) {
            ball.velY = Math.sin(angleRad) * speed;
            ball.y = e.height - radius
        }
        if ((ball.x + ball.radius) >= e.width) {
            ball.velX = -Math.cos(angleRad) * speed
        }
        ...
        ball.x += ball.velX;
        ball.y += ball.velY;
        var f = context1.createRadialGradient(ball.x, ball.y, 0, ball.x, ball.y, radius);
        f.addColorStop(0, "#e99");
        f.addColorStop(1, "#e00");
        context1.fillStyle = f;
        context1.beginPath();
        context1.arc(ball.x, ball.y, ball.radius, 0, Math.PI * 2, true);
        context1.closePath();
        context1.fill()
    }, addDot = function(f, h, g) {
        dotsX.push(f);
        dotsY.push(h);
        line.push(g)
    }, drawCanvas2 = function() {
        context2.clearRect(0, 0, canvas2.width, canvas2.height);
        context2.strokeStyle = "#e00";
        context2.lineJoin = "round";
        context2.lineWidth = 5;
        for (var f = 0; f < dotsX.length; f++) {
            context2.beginPath();
            if (line[f] && f) {
                context2.moveTo(dotsX[f - 1], dotsY[f - 1])
            } else {
                context2.moveTo(dotsX[f] - 1, dotsY[f])
            }
            context2.lineTo(dotsX[f], dotsY[f]);
            context2.closePath();
            context2.stroke()
        }
    };
    ...
    b.mousedown(function(f) {
        if (f.which == 1) {
            paint = true;
            addDot(f.pageX - this.offsetLeft, f.pageY - this.offsetTop);
            drawCanvas2()
        } else {
            if (f.which == 3) {
                dotsX = new Array();
    ...
    }).on("contextmenu", function(f) {
        f.preventDefault()
    }).mousemove(function(f) {
        if (paint) {
            addDot(f.pageX - this.offsetLeft, f.pageY - this.offsetTop, true);
            drawCanvas2()
        }
    ...
    $(window).resize(function() {
        d.attr("width", c.css("width"));
        if ((ball.x + ball.radius) >= d.width()) {
            ball.velX = -Math.cos(angleRad) * speed;
            ball.x = d.width() - radius
        }
...
function olCER() {
    $(".chr tr").each(function() {
        var d = 100,
            c = $(this),
            b = c.children(),
            a = b.first().children("span.bk");
        c.mouseenter(function() {
            if (!$.support.transition) {
                b.stop().animate({
                    top: "-1em",
...
function htmlColor(q, p, n, j) {
    ...
    return "#" + hex(Math.round(a)) + hex(Math.round(i)) + hex(Math.round(o))
}

function htmlGray(a, b) {
    var c = hex(Math.round(a * 255 / b));
    return "#" + c + c + c
}

function contrastColor(b) {
    var a = [].slice.call(arguments).join(",").replace(/rgb\(|\)|rgba\(|\)|\s/gi, "").split(",");
    luma = (0.2126 * a[0]) + (0.7152 * a[1]) + (0.0722 * a[2]);
    return (luma >= 165) ? "#222" : "#ddd"
}
...
function olColors() {
    $("#colorChart").mousemove(function(c) {
        var d = $(this),
            a = c.pageX - d.offset().left,
            e = c.pageY - d.offset().top,
            b = htmlColor(a, e, d.width(), d.height());
        $("#selCol").css("background-color", b);
        $("#selColText").text(b)
    });
    $("#grayChart").mousemove(function(b) {
        var c = $(this),
            a = htmlGray(b.pageX - c.offset().left, c.width());
        $("#selCol").css("background-color", a);
        $("#selColText").text(a)
    });
    $("#colorChart, #grayChart").mouseleave(function() {
        $("#selCol").css("background-color", $("#curCol").css("background-color"));
        $("#selColText").text($("#curColText").text())
    }).click(function() {
        $("#curCol").css("background-color", $("#selCol").css("background-color"));
        $("#curColText").text($("#selColText").text());
        if (typeof $("#curCol").data("selectedElement") != "undefined") {
            $selectedElement = $("#" + $("#curCol").data("selectedElement"));
            $selectedElementLabel = $("#" + $("#curCol").data("selectedElement") + "col");
            $selectedElement.css($selectedElement.data("property"), $("#curCol").css("background-color"));
            $selectedElementLabel.text(hexColor($("#curCol").css("background-color")))
        }
    });
    $("#ccb, #cct, #ccrpb, #ccrpt, #ccrpp, #ccp").click(function(a) {
        a.stopPropagation();
        var b = $(this);
        $("#ccb, #cct, #ccrpb, #ccrpt, #ccrpp, #ccp").css("border", "1px solid transparent");
        b.css("border", "1px dashed " + contrastColor($("#" + b.data("backcolor")).css("background-color")));
        $("#curCol").data("selectedElement", b.attr("id"))
    })
}
...
function olLangTags() {
    var c = new Array(),
        ...
        h = function() {
            e.extlang = new Array();
            e.variant1 = new Array();
            e.variant2 = new Array();
            e.variant3 = new Array();
            if (typeof c.language.data("selected") != "undefined") {
                var n = new Array();
                n.push({
                    name: c.language.data("selected"),
                    variant: 1
                });
                if (typeof c.extlang.data("selected") != "undefined") {
                    n.push({
                        name: c.extlang.data("selected"),
                        variant: 1
                    })
                }
                if (typeof c.variant1.data("selected") != "undefined") {
                    n.push({
                        name: c.language.data("selected") + "-" + c.variant1.data("selected"),
                        variant: 2
                    })
                }
                if (typeof c.variant1.data("selected") != "undefined" && typeof c.variant2.data("selected") != "undefined") {
                    n.push({
                        name: c.language.data("selected") + "-" + c.variant1.data("selected") + "-" + c.variant2.data("selected"),
                        variant: 3
                    })
                }
                if (typeof c.region.data("selected") != "undefined") {
                    n.push({
                        name: c.language.data("selected") + "-" + c.region.data("selected"),
                        variant: 1
                    })
                }
                if (typeof c.script.data("selected") != "undefined") {
                    n.push({
                        name: c.language.data("selected") + "-" + c.script.data("selected"),
                        variant: 1
                    })
                }
                if (typeof c.script.data("selected") != "undefined" && typeof c.variant1.data("selected") != "undefined") {
                    n.push({
                        name: c.language.data("selected") + "-" + c.script.data("selected") + "-" + c.variant1.data("selected"),
                        variant: 2
                    })
                }
                for (var m = 0; m < langTags.length; m++) {
                    if (langTags[m].type != "language" && langTags[m].type != "script" && langTags[m].type != "region") {
                        for (var l = 0; l < n.length; l++) {
                            if ($.inArray(n[l].name, langTags[m].prefix) != -1) {
                                if (langTags[m].type == "variant") {
                                    b(e["variant" + n[l].variant], {
                                        value: langTags[m].description,
                                        data: langTags[m].subtag
                                    })
                                } else {
                                    b(e[langTags[m].type], {
                                        value: langTags[m].description,
                ...
                g("script", 2);
                g("region", 2);
                if (e.variant1.length > 0) {
                    g("variant1", 1)
                } else {
                    f("variant1")
                }
                if (e.variant2.length > 0) {
                    g("variant2", 1)
                } else {
                    f("variant2")
                }
                if (e.variant3.length > 0) {
                    g("variant3", 1)
                } else {
                    f("variant3")
                }
                var k = "";
                if (typeof c.extlang.data("selected") != "undefined") {
                    k += c.extlang.data("selected")
                } else {
                    k += c.language.data("selected")
                }
                if (typeof c.script.data("selected") != "undefined") {
                    k += "-" + c.script.data("selected")
                }
                if (typeof c.region.data("selected") != "undefined") {
                    k += "-" + c.region.data("selected")
                }
                if (typeof c.variant1.data("selected") != "undefined") {
                    k += "-" + c.variant1.data("selected")
                }
                if (typeof c.variant2.data("selected") != "undefined") {
                    k += "-" + c.variant2.data("selected")
                }
                if (typeof c.variant3.data("selected") != "undefined") {
                    k += "-" + c.variant3.data("selected")
                }
                $("#langtag").text(k)
            } else {
                f("extlang");
                ...
                f("variant2");
                f("variant3");
                $("#langtag").text("[NO_DATA]")
            }
        },
        g = function(i, j) {
            c[i + "Input"].val("").autocomplete({
                lookup: e[i],
                minChars: j,
                onSelect: function(k) {
                    c[i].data("selected", k.data);
                    c[i + "Span"].css({
                        display: "inline-block"
                    }).append(document.createTextNode(c[i + "Input"].val()));
                    c[i + "Input"].val("").css({
                        display: "none"
                    });
                    h()
                ...
                if (c[i + "Span"].css("display") == "none" && c[i + "Input"].val() != "") {
                    c[i + "Input"].addClass("invalid")
                }
            }).focus(function() {
                c[i + "Input"].removeClass("invalid")
            });
            c[i].css({
                display: "block"
            })
        ...
        f = function(i) {
            c[i + "Input"].autocomplete("dispose").val("").removeClass("invalid").css({
                display: "inline-block"
            });
            c[i + "Span"].css({
                display: "none"
            ...
            c[i].removeData("selected").css({
                display: "none"
            })
        },
        d = function(i) {
            c[i + "Input"].val("").removeClass("invalid").css({
                display: "inline-block"
            }).focus();
            c[i].removeData("selected");
            c[i + "Span"].css({
                display: "none"
            }).contents().filter(function() {
                return this.nodeType === 3
    ...
    c.language = $("#language");
    c.languageInput = c.language.children("input");
    c.languageSpan = $("<span></span>").appendTo(c.language);
    c.extlang = $("#extlang");
    c.extlangInput = c.extlang.children("input");
    c.extlangSpan = $("<span></span>").appendTo(c.extlang);
    c.script = $("#script");
    c.scriptInput = c.script.children("input");
    c.scriptSpan = $("<span></span>").appendTo(c.script);
    c.region = $("#region");
    c.regionInput = c.region.children("input");
    c.regionSpan = $("<span></span>").appendTo(c.region);
    c.variant1 = $("#variant1");
    c.variant1Input = c.variant1.children("input");
    c.variant1Span = $("<span></span>").appendTo(c.variant1);
    c.variant2 = $("#variant2");
    c.variant2Input = c.variant2.children("input");
    c.variant2Span = $("<span></span>").appendTo(c.variant2);
    c.variant3 = $("#variant3");
    c.variant3Input = c.variant3.children("input");
    c.variant3Span = $("<span></span>").appendTo(c.variant3);
    $("<span>&times;</span>").click(function() {
        d("language")
    }).prependTo(c.languageSpan);
    $("<span>&times;</span>").click(function() {
        d("extlang")
    }).prependTo(c.extlangSpan);
    $("<span>&times;</span>").click(function() {
        d("script")
    }).prependTo(c.scriptSpan);
    $("<span>&times;</span>").click(function() {
        d("region")
    }).prependTo(c.regionSpan);
    $("<span>&times;</span>").click(function() {
        d("variant1")
    }).prependTo(c.variant1Span);
    $("<span>&times;</span>").click(function() {
        d("variant2")
    }).prependTo(c.variant2Span);
    $("<span>&times;</span>").click(function() {
        d("variant3")
    }).prependTo(c.variant3Span);
    e.language = new Array();
    e.script = new Array();
    e.region = new Array();
    for (var a = 0; a < langTags.length; a++) {
        if (langTags[a].type == "language" || langTags[a].type == "script" || langTags[a].type == "region") {
            e[langTags[a].type].push({
                value: langTags[a].description,
                data: langTags[a].subtag
            })
        }
    }
    g("language", 3)
...
function olDonate() {
    $("#donfrm input").bind("change", function(b) {
        var c = $(this),
            a = 0;
        while ($("#ppfrm" + a).length) {
            if (a == c.data("amount")) {
                $("#ppfrm" + a).css("display", "block")
            } else {
                $("#ppfrm" + a).css("display", "none")
            }
            a++
        }
    })
...
function changeColor(a, b) {
    if (typeof $(a).data("transparentBackground") == "undefined" || $(a).data("transparentBackground")) {
        $(a).css({
            backgroundColor: "#a3cd52"
        });
        $(a).data("transparentBackground", 0)
    } else {
        $(a).css({
            backgroundColor: "transparent"
        });
        $(a).data("transparentBackground", 1)
    }
}

function menuChangeColorTo(c, a) {
    var b = document.getElementById("paragraph" + c);
    $(b).data("transparentBackground", 0);
    if (a == "red") {
        $(b).css({
            backgroundColor: "#e06e58"
        })
    } else {
        if (a == "green") {
            $(b).css({
...
function menuCambiarColorA(c, a) {
    var b = document.getElementById("parrafo" + c);
    $(b).data("transparentBackground", 0);
    if (a == "rojo") {
        $(b).css({
            backgroundColor: "#e06e58"
...
function mostrarPotencia() {
    var b = parseFloat(document.getElementById("base").value),
        a = parseFloat(document.getElementById("exponente").value);
    document.getElementById("potencia").value = Math.pow(b, a)
}

function outputPower() {
    var b = parseFloat(document.getElementById("base").value),
        a = parseFloat(document.getElementById("exponent").value);
    document.getElementById("power").value = Math.pow(b, a)
}

function outputAudienceReaction() {
    var a = parseFloat(document.getElementById("volumeofmusic").value),
        b;
    if (a <= 20) {
        b = "I can't even hear the music!"
    } else {
        if (a > 20 && a <= 40) {
            b = "Too low! Rise it just a bit, would you?"
        } else {
            if (a > 40 && a <= 60) {
                b = "That's great! Leave it there."
            } else {
                if (a > 60 && a <= 80) {
                    b = "It's too much! I can't concentrate."
                } else {
                    if (a > 80) {
    ...
    document.getElementById("audiencereaction").value = b
}

function mostrarReaccionAudiencia() {
    var a = parseFloat(document.getElementById("volumenmusica").value),
        b;
    if (a <= 20) {
        b = "Ni siquiera puedo escuchar la música!"
    } else {
        if (a > 20 && a <= 40) {
            b = "Muy bajo! Súbela solo un poquito, ¿si?"
        } else {
            if (a > 40 && a <= 60) {
                b = "Está genial! Déjala ahí."
            } else {
                if (a > 60 && a <= 80) {
                    b = "Es demasiado! No me puedo concentrar."
                } else {
                    if (a > 80) {
                        b = "No puedo escuchar NADA!"
                    }
                }
            }
        }
    }
    document.getElementById("reaccionaudiencia").value = b
}

function outputUsername() {
    var a = randomNumber(0, 2);
    if (a < 1) {
        document.getElementById("usernameavailability").value = "Username already picked!"
    } else {
        document.getElementById("usernameavailability").value = "Good! That username is available!"
    }
}
...
function mostrarNombreUsuario() {
    var a = randomNumber(0, 2);
    if (a < 1) {
        document.getElementById("disponibilidadusuario").value = "Nombre de usuario ya elegido!"
    } else {
        document.getElementById("disponibilidadusuario").value = "Bien! Ese nombre de usuario está disponible!"
    }
}

function progressTransferFile() {
    var a = document.getElementById("filetransfer");
    if (a.value < 1) {
        a.value += 0.01;
        setTimeout(progressTransferFile, 20)
    }
}

function progresoTransferenciaArchivo() {
    var a = document.getElementById("transferenciaarchivo");
    if (a.value < 1) {
        a.value += 0.01;
        setTimeout(progresoTransferenciaArchivo, 20)
    }
}

function openDialog(a, d) {
    var c = false;
...
function abrirDialogo(a, b) {
    openDialog(a, b)
}

function cerrarDialogo(a) {
    closeDialog(a)
}

function switchFieldset(a) {
    $(a).closest("fieldset").prop("disabled", !$(a).prop("checked"))
}

function alternarFieldset(a) {
    $(a).closest("fieldset").prop("disabled", !$(a).prop("checked"))
};
